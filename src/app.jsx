...
import { ListingCreationConfirmationPage } from "./cmps/ListingCreationConfirmationPage"
    ...
    <Router>
      <Routes>
        ...
        <Route element={<HostLayout />}>
          ...
          <Route path="/listing-confirmation" element={<ListingCreationConfirmationPage />} />
        </Route>
      </Routes>
    </Router>
  )
